...
\begin{table*}[t]
	\begin{center}
		...
		\begin{tabular}{|c|c|c|}
			\hline
			{\parbox{60mm}{\centering Application}} & {Min improvement} & {\parbox{20mm}{\centering Max Improvement}} \\
			\hline
			{\parbox{60mm}{\centering Cholesky 32K 256 (128$\times$128)}} & 0 & 3\% \\                                 
			\hline
			{\parbox{60mm}{\centering Cholesky 32K 128 (256$\times$256)}} & 0 & 2\%  \\
			\hline
			{\parbox{60mm}{\centering Cholesky 16K 512 (32$\times$32)}} & 1\% & 22\% \\
			\hline
			QR 512 & 0 & 61\% \\
			\hline
			QR 128 & 0 & 2\% \\
...
Moving in more detail, Table~\ref{tab.taskgenx_cats} shows the minimum and maximum improvements obtained from each workload.
TaskGenX+CATS improves TaskGenX+BF by around 2\% for the two cholesky workloads used here. 
